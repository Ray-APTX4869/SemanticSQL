...
from agent.agent_curation import react_agent_graph
...
# Streamlit UI
st.title("🧠 指标解析助手")
st.markdown("输入指标定义和相关 SQL 代码，自动解析指标含义")

user_input = st.text_input("请输入指标定义和相关 SQL 代码")
# print(prompt_val.messages.pretty_print())

if st.button("解析指标"):
    with st.spinner("正在解析指标..."):
